defmodule SimonWeb.CoreComponents do
  @moduledoc """
  ...
  def input(%{type: "checkbox", value: value} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      <label class="flex items-center text-sm gap-4 leading-6 text-zinc-600">
  ...
  def error(assigns) do
    ~H"""
    <p class="flex mt-3 text-sm gap-3 leading-6 text-rose-600 phx-no-feedback:hidden">
  ...
  def list(assigns) do
    ...
    <div class="mt-14">
      <dl class="-my-4 divide-y divide-zinc-100">
        <div :for={item <- @item} class="flex py-4 text-sm gap-4 leading-6 sm:gap-8">
